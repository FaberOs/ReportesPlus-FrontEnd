...
function ToastNotify({accionar, tipo}) {
    ...
    return (
        <ToastContainer position="position-absolute" className="top-0 end-0 p-5" style={{ zIndex: 1 }}>
            {
                tipo === 'I'
                        ...
                        <Toast.Body >
                                <Row md={0}> 
                                    ...
                                    <Col className="textdisposicion" xs={7}>                                
                                        <h5><strong className="me-auto text-white">Info</strong></h5>
                                        <h6 className='text-white'>Information notification message.</h6>
                                    </Col>                            
                                    <Col >
                        ...
                        ?<Toast  show={showA} onClose={toggleShowA} bg={'warning'}  >
                            <Toast.Body >
                                    <Row md={0}> 
                                        ...
                                        <Col className="textdisposicion" xs={7}>                                
                                            <h5><strong className="me-auto text-white">Warning</strong></h5>
                         ...
                         ?<Toast  show={showA} onClose={toggleShowA} bg={'danger'}  >
                            <Toast.Body >
                                    <Row md={0}> 
                                        ...
                                        <Col className="textdisposicion" xs={7}>                                
                                            <h5><strong className="me-auto text-white">Error</strong></h5>
                        ...
                        :<Toast  show={showA} onClose={toggleShowA} bg={'success'}  >
                            <Toast.Body >
                                    <Row md={0}> 
                                        ...
                                        <Col className="textdisposicion" xs={7}>                                
                                            <h5><strong className="me-auto text-white">Success</strong></h5>
